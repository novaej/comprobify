...
- This is a manual-pipeline-only concept — once a real gateway (Kushki, NEXT_STEPS.md #9) exists, it owns the recurring charge schedule natively and this cron-driven reminder/grace/expire cycle becomes Kushki-specific automation territory, not a redesign.

...
| `src/controllers/subscription.controller.js` / `src/routes/subscriptions.routes.js` | Tenant-facing `GET /v1/subscriptions/me` (full subscription/payment history) and `POST /v1/subscriptions/change-tier` — both behind `authenticate` middleware |

...
module.exports = {
  updateTenantTier, updateTenantStatus, verifyTenant, promoteTenant, listTenantEvents,
  renewIssuerCertificate, createApiKey, listApiKeys, getApiKeyUsage, revokeApiKey,

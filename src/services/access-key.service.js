...
const { generarClaveAcceso } = require('../../helpers/generar-clave-acceso');
...
async function generate({ issueDate, documentType, ruc, environment, branchCode, issuePointCode, sequential, emissionType }) {
  ...
  return generarClaveAcceso(dateMoment, ruc, documentType, environment, emissionType || '1', invoiceNumber, numericCode);
}

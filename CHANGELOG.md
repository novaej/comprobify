...
- **`GET /v1/payments/:id/proof`** — tenants can now download the proof-of-transfer file they previously uploaded for a payment. Ownership enforced via the subscription join — a tenant can only retrieve their own files.

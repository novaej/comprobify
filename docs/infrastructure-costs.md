...
- Excludes payment-processing fees (none currently — no gateway exists yet, `NEXT_STEPS.md` #5) and income tax on profit (a matter for the accountant, out of scope here).

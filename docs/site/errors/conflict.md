...
Se pidió reenviar el correo de verificación (desde la aplicación web) para una dirección cuya cuenta ya está activa (correo ya verificado). No hay nada que reenviar.

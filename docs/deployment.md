...
- [ ] `PAYPHONE_TOKEN` / `PAYPHONE_STORE_ID` set per environment (staging pointed at the Payphone **test** store, never the live one) — or deliberately left unset to keep card payments disabled

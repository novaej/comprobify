...
**Status:** investigation complete; the mechanical, no-design-decision fixes were applied the same day (#4, #7, #8, #10, #11 below — see each item for what changed). **#1, #2, and #3 are now resolved** (2026-09-14) — see each entry for how. #5, #6, #9, #12–16 remain open, tracked here.

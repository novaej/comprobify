...
**Status:** investigation complete; the mechanical, no-design-decision fixes were applied the same day (#4, #7, #8, #10, #11 below — see each item for what changed). **#1, #2, #3, #5, and #6 are now resolved** (2026-09-14) — see each entry for how. **#17 reviewed 2026-09-14 — no action needed for now**, see its entry. #9, #12–16 remain open, tracked here.
